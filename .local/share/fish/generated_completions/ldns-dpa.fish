# ldns-dpa
# Autogenerated from man page /usr/lib/jvm/default/man/man1/ldns-dpa.1.gz
...
complete -c ldns-dpa -s u --description 'Count every occurence of every value of the matchname (for instance, count al…'
